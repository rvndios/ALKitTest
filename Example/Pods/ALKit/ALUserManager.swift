...
open class ALUserManager {
    
    @available(*, deprecated: 10.0, message: "ALUserManager is deprecated")
    public static let defaultKeychainWrapper = ALUserManager.standard
    
    /// Default keychain wrapper access
    public static let standard = ALUserManager()
    ...
    private convenience init() {
        self.init(serviceName: ALUserManager.defaultServiceName)
    }
